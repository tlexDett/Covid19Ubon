    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <p>รานงานประจำวันนี้ พบรายใหม่ {{$json->NewConfirmed}} ราย กลับบ้านมากขึ้นรวม {{$json->NewHospitalized}} ราย พบผู้เสียชีวิต {{$json->NewDeaths}} ราย รวมเป็น {{$json->Deaths}} ราย </p>
                <hr>
                <!-- -----------Evaluate------------- -->
                <div class="container">
                ...
                <div class="links">
                    ...
                    <a href="">News</a>
                    <a href="{{ url('/admin/posts') }}">CaseSum</a>
                    <a href="">GitHub</a>
                </div>
                <br>
